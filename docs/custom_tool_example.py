...
from orionagent.tools.base import BaseTool, BaseResult
from orionagent.agents import AgentProfile, OrionAgentSystem
from orionagent.config import Config, CFG
...
if __name__ == "__main__":
    input_dict = {
        "lang": "en",
        "llm_name": "OrionAgentlms_qwen_7b_mat",
    }
    ...
    # OrionAgentSystem wrapper could be used here in the future
    agent = OrionAgentSystem(
            cfg=cfg,
