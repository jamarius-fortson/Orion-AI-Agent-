...
class ChatBaichuan:
    def __init__(self,
            model_name_or_path: str = "kwaikeg/OrionAgentlms_baichuan2_13b_mat",
    ...
    def chat(self, query, *args, **kwargs):
        ...
        if mode == 'SINGLE_INFER':
            ...
            raise TypeError(f'queryå¿…é¡»ä¸ºstræˆ–list,å½“å‰ä¸º{type(query)}')
        ...
        if len(prompt_tokens) > input_max_length:
            if prune_text is None or prune_text not in query:
                ...
                if start_index is None:
                    ...
                    # é™¤äº†memoryçš„å…¶ä»–éƒ¨åˆ†çš„é•¿åº¦
