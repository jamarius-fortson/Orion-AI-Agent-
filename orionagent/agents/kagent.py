...
from orionagent.tools import ALL_NO_TOOLS, ALL_TOOLS, FinishTool, NoTool
from orionagent.llms import create_chat_completion
from orionagent.agents.prompts import make_planning_prompt
from orionagent.agents.prompts import make_no_task_conclusion_prompt, make_task_conclusion_prompt
from orionagent.utils.chain_logger import *
from orionagent.utils.json_fix_general import find_json_dict, correct_json
...
class OrionAgentSystem(object):
    ...
    def initialize_tokenizer(self, llm_name):
        if "baichuan" in llm_name:
            model_name = "kwaikeg/OrionAgentlms_baichuan2_13b_mat"
        elif "qwen" in llm_name:
            model_name = "kwaikeg/OrionAgentlms_qwen_7b_mat"
        else:
            model_name = "gpt2"
    ...
    def conclusion(self, 
        ...
        response, _ = create_chat_completion(
            query=prompt, 
            chat_id="orionagent_answer_" + self.session_id, 
