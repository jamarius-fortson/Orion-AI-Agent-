...
from orionagent.utils.date_utils import get_date_list
...
class CalendarTool(BaseTool):
    ...
    def __call__(self, start_date, end_date, *args, **kwargs):
        ...
        for date in date_list:
            ...
            huangli_str.append({"é˜³åŽ†": yangli, "é˜´åŽ†": yinli, "ç”Ÿè‚–": shengxiao, "æ˜Ÿåº§": xingzuo, "èŠ‚æ°”": jieqi, "èŠ‚æ—¥": jieri})

        return CalendarResult(
            {
                "å¾…æŸ¥æ—¥åŽ†ä¿¡æ¯": huangli_str,
            }
        )
